...
public class Ejemplo3urlCon {
	...
	public static void main(String[] args) throws Exception {
		String cadena;
		URL url = new URL("http://localhost/2018/index.html");
		URLConnection conexion = url.openConnection();
		
		System.out.println("Direccion [get URL()]: "+ conexion.getURL());
		...
		System.out.println("TODOS LOS CAMPOS DE CABECERAS CON getHeaderFields(): ");
		...
		while(it.hasNext()) {
			...
			System.out.println("============================================================");
			System.out.println("CONTENDIO DE [url.getFile()]: "+ url.getFile());
